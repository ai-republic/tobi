...
/**
 * A utility class for handling URI template parameters. As the Java regulare expressions package
 * does not handle named groups, this class attempts to simulate that functionality by using groups.
 *
 * @author Ryan J. McDonough
 * @author Bill Burke
 * @since 1.0 Nov 8, 2006
 */
public class PathHelper {
    ...
    public static String getEncodedPathInfo(String path, final String contextPath) {
    ...
    public static String replaceEnclosedCurlyBraces(final String str) {
    ...
    // */
    // public static CharSequence replaceEnclosedCurlyBracesCS(final String str) {
    // int open = 0;
    // CharSequence cs = str;
    // char[] chars = null;
    ...
    public static String recoverEnclosedCurlyBraces(final String str) {

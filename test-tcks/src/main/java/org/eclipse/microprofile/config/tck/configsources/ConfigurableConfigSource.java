...
/**
 * A ConfigSource which can be used to play through multiple different scenarios in our TCK.
 *
...
public class ConfigurableConfigSource implements ConfigSource {
    ...
    public static void configure(final Config cfg, final String propertyName, final String value) {
        for (final ConfigSource configSource : cfg.getConfigSources()) {
            if (configSource instanceof ConfigurableConfigSource) {
                final ConfigurableConfigSource configurableConfigSource = (ConfigurableConfigSource) configSource;

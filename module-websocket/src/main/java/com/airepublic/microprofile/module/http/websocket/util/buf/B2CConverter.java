 ...
 */
package com.airepublic.microprofile.module.http.websocket.util.buf;
...
public class B2CConverter {
    ...
    public static Charset getCharset(final String enc) throws UnsupportedEncodingException {
        ...
        final Charset charset = charsetCache.getCharset(lowerCaseEnc);
    ...
    public B2CConverter(final Charset charset, final boolean replaceOnError) {
        final byte[] left = new byte[LEFTOVER_SIZE];
     ...
     */
    public void convert(final ByteChunk bc, final CharChunk cc, final boolean endOfInput)
            throws IOException {
     ...
     * @throws IOException If the conversion can not be completed
     */
    public void convert(final ByteBuffer bc, final CharBuffer cc, final ByteChunk.ByteInputChannel ic, final boolean endOfInput)
            throws IOException {

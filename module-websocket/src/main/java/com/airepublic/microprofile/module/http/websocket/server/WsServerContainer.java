...
import com.airepublic.microprofile.core.pathmatcher.PathMapping;
import com.airepublic.microprofile.core.pathmatcher.TemplatePathMatch;
import com.airepublic.microprofile.module.http.websocket.SimpleInstanceManager;
import com.airepublic.microprofile.module.http.websocket.WsSession;
import com.airepublic.microprofile.module.http.websocket.WsWebSocketContainer;
import com.airepublic.microprofile.module.http.websocket.pojo.PojoMethodMapping;
...
public class WsServerContainer extends WsWebSocketContainer implements ServerContainer {
    ...
    private volatile boolean enforceNoAddAfterHandshake = com.airepublic.microprofile.module.http.websocket.Constants.STRICT_SPEC_COMPLIANCE;
    ...
    public void addEndpoint(final ServerEndpointConfig sec) throws DeploymentException {
        ...
        try {
            ...
            if (methodMapping.getOnClose() != null || methodMapping.getOnOpen() != null || methodMapping.getOnError() != null || methodMapping.hasMessageHandlers()) {
                sec.getUserProperties().put(com.airepublic.microprofile.module.http.websocket.pojo.Constants.POJO_METHOD_MAPPING_KEY, methodMapping);
            }

 ...
 */
package com.airepublic.microprofile.module.http.websocket.util.threads;
 ...
 * subsequent requests to acquire the latch will be placed in a FIFO queue until one of the shares
 * is returned.
 */
public class LimitLatch {
    ...
    /**
     * Sets a new limit. If the limit is decreased there may be a period where more shares of the
     * latch are acquired than the limit. In this case no more shares of the latch will be issued
     * until sufficient shares have been returned to reduce the number of acquired shares of the
     * latch to below the new limit. If the limit is increased, threads currently in the queue may
     * not be issued one of the newly available shares until the next request is made for a latch.
     *
    ...
    /**
     * Releases all waiting threads and causes the {@link #limit} to be ignored until
